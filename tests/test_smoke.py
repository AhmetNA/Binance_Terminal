...
class TestBasicFunctionality(unittest.TestCase):
    ...
    def test_project_structure(self):
        ...
        project_root = os.path.dirname(current_dir)  # tests klasörünün üstü proje root'u
    ...
    def test_src_directory_structure(self):
        ...
        for dir_name in essential_dirs:
            ...
            self.assertTrue(os.path.exists(dir_path), f"Missing src subdirectory: {dir_name}")
    ...
    def test_configuration_files(self):
        ...
        if os.path.exists(config_dir):
            ...
            example_files = [
                ...
                'fav_coins_example.json'
            ]
            
            for file_name in example_files:
                file_path = os.path.join(config_dir, file_name)
                # It's OK if example files don't exist, but check if directory is readable
                self.assertTrue(os.access(config_dir, os.R_OK), f"Config directory not readable")
        ...
        if os.path.exists(data_dir):
            ...
            for subdir_name in data_subdirs:
                ...
                if os.path.exists(subdir_path):
                    self.assertTrue(os.path.isdir(subdir_path), f"Data subdirectory is not a directory: {subdir_name}")
